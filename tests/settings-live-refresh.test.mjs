...
const settingsListenerSrc = fs.readFileSync(path.join(HERE, '..', 'src', 'instance', 'settings-listener.js'), 'utf8');
...
const settingsDefaultsSrc = fs.readFileSync(path.join(HERE, '..', 'src', 'settings', 'defaults.js'), 'utf8');
