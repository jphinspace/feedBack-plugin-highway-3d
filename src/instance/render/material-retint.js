...
export function createMaterialRetint({
  ...
  function applyPaletteToMaterials() {
    const mStr = getMStr(); const mGlow = getMGlow(); const mSus = getMSus(); const
      mRimFlash = getMRimFlash();
    const mStrHitOutline = getMStrHitOutline(); const
      mAccentOutline = getMAccentOutline();
    const mAccentCore = getMAccentCore();
    const mAccentHaloNear = getMAccentHaloNear(); const
      mAccentHaloMid = getMAccentHaloMid();
    const mAccentHaloFar = getMAccentHaloFar(); const
      projMeshArr = getProjMeshArr();
  ...
  function applyVibrancy() {
    const mStr = getMStr(); const mSus = getMSus(); const mGlow = getMGlow(); const
  ...
  function applyGlow() {
    const mStr = getMStr(); const
      projMeshArr = getProjMeshArr();
    const mStrHitOutline = getMStrHitOutline(); const
      mAccentOutline = getMAccentOutline();
    const mWhiteOutline = getMWhiteOutline(); const
      mMissOutline = getMMissOutline();
    const mHitBright = getMHitBright(); const
      mSusOutline = getMSusOutline();
    const mHitSusOutline = getMHitSusOutline(); const mTapChevron = getMTapChevron(); const
      mBarre = getMBarre();
    const mAccentHaloNear = getMAccentHaloNear(); const
      mAccentHaloMid = getMAccentHaloMid();
  ...
  return {
    applyPaletteToMaterials, recolorGemGradients, applyVibrancy, applyGlow, applyVerdictGlow,
  };
}
