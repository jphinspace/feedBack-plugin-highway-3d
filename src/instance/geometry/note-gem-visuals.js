 ...
 */
export function createNoteGemVisuals({
  activePalette, glowMul, noteG, _recolorGemGradients, _ownedSharedGeos, gHaloBar: _gHaloBarIn,
}) {
  ...
  const mWhiteOutline = new T.MeshLambertMaterial({
    color: 0xffffff, emissive: 0xffffff, emissiveIntensity: 0.6, transparent: true, opacity: 1.0, depthWrite: false,
  });
  ...
  const mAccentOutline = activePalette.map((c) => new T.MeshLambertMaterial({
    color: c,
    emissive: c,
    emissiveIntensity: ACCENT_RIM_BASE_EMISSIVE,
    transparent: true,
    opacity: 1.0,
    depthWrite: false,
  }));
  ...
  const mMissOutline = new T.MeshLambertMaterial({
    color: 0xff0066, emissive: 0xff0066, emissiveIntensity: 1.2, transparent: true, opacity: 1.0, depthWrite: false,
  });
  ...
  const mSusOutline = new T.MeshLambertMaterial({
    color: 0xffffff, emissive: 0xffffff, emissiveIntensity: 0.3, transparent: true, opacity: 0.75, depthWrite: false,
  });
  const mHitSusOutline = new T.MeshLambertMaterial({
    color: 0x22ff88, emissive: 0x22ff88, emissiveIntensity: 0.8, transparent: true, opacity: 0.45, depthWrite: false,
  });
