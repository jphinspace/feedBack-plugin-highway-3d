...
export function createBackgroundMount({
  ...
  function applyVenueSceneFog(active) {
    const scene = getScene(); const ren = getRen(); const
      ambLight = getAmbLight();
  ...
  function _applyBgTheme() {
    const scene = getScene(); const
      ren = getRen();
    const mLaneOdd = getMLaneOdd(); const
      mLaneEven = getMLaneEven();
