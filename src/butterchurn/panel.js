...
let presetPanelEl = null; let
  panelHotkeyBound = false;
...
export function ensurePresetPanel(host) {
  ...
  p.innerHTML = `<div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:7px"><span style="font-weight:600">🌀 Visualizer</span><button id="vz-listbtn" title="Show / hide full preset list" style="${PANEL_BUTTON_CSS};padding:1px 7px">&lt;&lt;</button></div>`
