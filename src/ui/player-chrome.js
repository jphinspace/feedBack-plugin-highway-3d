...
export let reactiveWrapEl = null; export let intensityWrapEl = null; export let
  reasonEl = null;
export let settingsBusListener = null; export let mountRetryCount = 0; export let
  mountRetryTimer = 0;
...
export function bindScreenChangedHook() {
  ...
  try { bus.on('screen:changed', screenChangedHook); } catch (e) { screenChangedHook = null; }
}
