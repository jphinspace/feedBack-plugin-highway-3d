...
export function venueMoodCoeffs(state) {
  ...
  if (s === 'fire' || s === 'strong') {
    return {
      light: 1.0, crowd: 0, haze: 0.012, warmth: 1.02,
    };
  }
  if (s === 'recovery' || s === 'smoke') {
    return {
      light: 0.55, crowd: 0, haze: 0.032, warmth: 0.94,
    };
  }
  return {
    light: 0.72, crowd: 0, haze: VENUE_HAZE_STEADY, warmth: 0.96,
  };
}
