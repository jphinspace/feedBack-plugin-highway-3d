 ...
 * `{config_dir}/plugin_uploads/highway_3d_dev/` and served same-origin by
...
export const video = {
  build(scene, settings) {
    ...
    const url = `/api/plugins/highway_3d_dev/files/${filename}`;
    ...
    let videoEl = null; let tex = null; let geo = null; let mat = null; let
      mesh = null;
    try {
      ...
      state.applyCoverCrop = function applyCoverCrop() {
