  ...
  build(scene, settings) {
    ...
    const ico = new T.Mesh(
      ...
      new T.MeshBasicMaterial({
        color: 0x6080c0, wireframe: true, transparent: true, opacity: op, depthWrite: false,
      }),
    );
    ...
    const torus = new T.Mesh(
      ...
      new T.MeshBasicMaterial({
        color: 0xc06080, wireframe: true, transparent: true, opacity: op * 0.9, depthWrite: false,
      }),
    );
